...
@Entity
@Table(uniqueConstraints = {@UniqueConstraint(columnNames={"userIdentifier","type"})})
public class UserIdentifier extends _Super_UserIdentifier
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1773258786648300032L;
