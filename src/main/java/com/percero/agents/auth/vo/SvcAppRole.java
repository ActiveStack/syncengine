...
/**
 * This is the persistence class for the ServiceApplication entity.
 *
 * This is a sub-class of _Super_ServiceApplication.java
 ...
 * com.com.percero.agents.auth.vo.ServiceApplication in the classpath of the LCDS web application.
 *
...
@Entity
public class SvcAppRole extends _Super_SvcAppRole
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1076764090700083810L;
