...
public class Client extends _Super_Client
{

	public static final String PERSISTENT_TYPE = "P";
	public static final String BIT_WISE = "B";
	public static final String NON_PERSISTENT_TYPE = "N";
}