...
//        postDeleteHelper.postDeleteObject(new ClassIDPair(id, className), null, null, true);
    ...
    private void pushPair(ClassIDPair pair, MappedField mappedField){
        try {
            ...
            logger.error("Error pushing ClassIDPair" + mappedField.getMappedClass().className + "." + mappedField.getField().getName(), e);
        }
    }
