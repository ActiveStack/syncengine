...
//
//@Component
//public class JedisCacheDataStore implements ICacheDataStore {
//
//	private static Logger log = Logger.getLogger(JedisCacheDataStore.class);
//	
...
//		if (forceNow) {
//			Long numSeconds = timeUnit.convert(timeout, TimeUnit.SECONDS);
//			return jc.expire(key, numSeconds.intValue()) > 0;
//		}
//		else {
...
//				Long numSeconds = timeUnit.convert(timeout, TimeUnit.SECONDS);
//				if ( jc.expire(itrKeys.next(), numSeconds.intValue()) <= 0 ) {
//					return false;
//				}
//			}
//			return true;
...
//			while (itrKeys.hasNext()) {
//				String nextKey = itrKeys.next();
//				String nextValue = jc.get(nextKey);
//				if (nextValue != null) {
...
//			Iterator<?> itrKeysAndValuesMap = keysAndValuesMap.entrySet().iterator();
//			while (itrKeysAndValuesMap.hasNext()) {
//				Entry<String, ? extends Object> nextEntry = (Entry<String, ? extends Object>) itrKeysAndValuesMap.next();
//				jc.set(nextEntry.getKey(), (String) nextEntry.getValue());
//			}
//		}
//	}
//	
...
//		return jc.sadd(key, (String) value);// ? Long.valueOf(1) : Long.valueOf(0);
//	}
//	
//	/* (non-Javadoc)
...
//		return jc.lpush(key, (String) value);
//	}
//	
//	/* (non-Javadoc)
...
//	@Override
//	@Transactional
//	public List<? extends Object> listAll( final String key) {
...
//	@Override
//	@Transactional
//	public List<? extends Object> listRange( final String key, final Long start, final Long end ) {
...
//		return jc.lindex(key, Long.valueOf(0));
//	}
//	
//	/* (non-Javadoc)
...
////		return jc.hmget(getHashKeys(key));
////	}
//	
//	/* (non-Javadoc)
...
//		jc.hset(key, hashKey, (String) value);
//	}
//	
//	/* (non-Javadoc)
